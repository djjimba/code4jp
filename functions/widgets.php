...
class SS_Twitter_Feed_Widget extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		// Refresh Cache
		delete_transient('ss_framework_twitter_feed');
	...
	function widget( $args, $instance ) {
		...
		// Display tweets
		echo ss_framework_twitter_feed( $username, $tweet_count, $ignore_replies );
...
class SS_Flickr_Feed_Widget extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		// Refresh Cache
		delete_transient('ss_framework_flickr_feed');
	...
	function widget( $args, $instance ) {
		...
		// Display images
		echo ss_framework_flickr_feed( $flickr_id, $image_count );
